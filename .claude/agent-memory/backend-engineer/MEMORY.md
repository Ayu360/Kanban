...
- [Project: Auth Backend Implementation](project_auth_backend.md) — Auth backend complete; frontend UI files still reference deleted authSlice and need frontend engineer handoff
- [Project: Teams Backend Implementation](project_teams_backend.md) — Teams backend complete; types, repo, service, server actions, hooks, container wiring, frontend handoff all done
